...
def main():
    ...
    print(f"                        (ton): {erg_to_ton(ke_asteroid_ctype_erg)}")
    print(f"1-km asteroid S-type KE (erg): {ke_asteroid_stype_erg}")
    print(f"                        (ton): {erg_to_ton(ke_asteroid_stype_erg)}")
    print(f"1-km asteroid M-type KE (erg): {ke_asteroid_mtype_erg}")
    print(f"                        (ton): {erg_to_ton(ke_asteroid_mtype_erg)}")
    print()
    print(f"1-km asteroid mean KE (erg): {ke_asteroid_1km_mean_erg}")
    print(f"                      (ton): {erg_to_ton(ke_asteroid_1km_mean_erg)}")
    print()
    print(f"Ceres asteroid KE (erg): {ke_asteroid_ceres_erg}")
    print(f"                  (ton): {erg_to_ton(ke_asteroid_ceres_erg)}")
